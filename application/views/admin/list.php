        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <h3 class="card-title"> <i class="fa fa fa-sign-out mr-10" aria-hidden="true"></i>  DAFTAR ADMIN</h3>                    
                    <div class="toolbar">
                    </div>
                    <div class="material-datatables">
                        ...
                        <table id="kios-datatable" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>nama lengkap</th>
                                <th>username</th>
                                <th class="text-center">passwod</th>
                                <th class="actions">Actions</th>
                            </tr>
                            </thead>							
                            <tbody>                           
                            <?php $no = 1; if(isset($admin)){ foreach($admin as $row) { ?>
                                <tr>
                                    <td><?php echo $no++;?></td>

<?php $this->load->view('shared/css_content');?>
    <div class="row" id="barang-masuk">
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <h3 class="card-title"> <i class="fa fa-sign-in mr-10" aria-hidden="true"></i>  BARANG MASUK</h3>
                    <div class="toolbar">
                    </div>
    ...
    $(document).ready(function() {	   
    	...
    	dt_table = $("#kios-datatable").DataTable({
				"processing": true,
				    	"serverSide": true,
				    	"ajax"		: {
				            			"url": "<?php echo my_url();?>barangmasuk/data",
							            "data": function ( d ) {
		...
		$("#barang-masuk").on("click","#add",function(){
		...
		$("#barang-masuk").on("click","#cancel-add",function(){
			hideFormAddNew();
			return false;
			});
		$("#barang-masuk").on("click","#cancel-search",function(){
			hideFormSearch();
			return false;
			});
			
		$("#barang-masuk").on("click","#adv-search",function(){
		...
		$("#barang-masuk").on("click","#save", function(){ 		
        ...
        $("#kios-datatable").on("click",".delete",function(){
            if(confirm("Yakin menghapus ini ?")){
                ...
                $.ajax({
                    url: "<?php echo my_url().'barangmasuk/hapus';?>",
                    type: 'POST',
                    dataType:'json',
                    data: {
                        id:id
        ...
        $("#barang-masuk").on("click","#go-search",function(){
            dt_table.draw();
            return false;
        });

<?php $this->load->view('shared/css_content');?>
    <div class="row" id="barang-keluar">
        <div class="col-md-12">
            <div class="card">
                <div class="card-content">
                    <h3 class="card-title"> <i class="fa fa fa-sign-out mr-10" aria-hidden="true"></i>  BARANG KELUAR</h3>
                    <div class="toolbar">
                    </div>
    ...
    $(document).ready(function() {	   
    	...
    	dt_table = $("#kios-datatable").DataTable({
				"processing": true,
				    	"serverSide": true,
				    	"ajax"		: {
				            			"url": "<?php echo my_url();?>barangkeluar/data",
							            "data": function ( d ) {
		...
		$("#barang-keluar").on("click","#add",function(){
		...
		$("#barang-keluar").on("click","#cancel-add",function(){
			hideFormAddNew();
			return false;
			});
		$("#barang-keluar").on("click","#cancel-search",function(){
			hideFormSearch();
			return false;
			});
			
		$("#barang-keluar").on("click","#adv-search",function(){
		...
		$("#barang-keluar").on("click","#save", function(){
            ...
            $.ajax({
                url: "<?php echo my_url().'barangkeluar/tambah';?>",
                type: 'POST',
                dataType:'json',
                data: {
        ...
        $("#kios-datatable").on("click",".delete",function(){
            if(confirm("Yakin menghapus ini ?")){
                ...
                $.ajax({
                    url: "<?php echo my_url().'barangkeluar/hapus';?>",
                    type: 'POST',
                    dataType:'json',
                    data: {
                        id:id
        ...
        $("#barang-keluar").on("click","#go-search",function(){
            dt_table.draw();
            return false;
        });
